...
<body>
	...
	<h4>파싱</h4>
	<x:out select="$blist/booklist/book[1]/name" escapeXml="true" /> <br />
	<x:out select="$blist/booklist/book[1]/author" escapeXml="true" /> <br />
	<x:out select="$blist/booklist/book[1]/price" escapeXml="true" /> <br />
